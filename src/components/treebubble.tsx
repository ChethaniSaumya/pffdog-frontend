...
export const TreeBubble: FC = () => {
    ...
    async function mintWithSolPayment() {
        ...
        try {
            ...
            const response = await axios.post('https://puffdog-backend.onrender.com/api/mint', payload, {
                headers: {
    ...
    async function createMerkleTree() {
        ...
        try {
            ...
            const response = await axios.post('https://puffdog-backend.onrender.com/api/createMerkleTree', {
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
                },
    ...
    async function createCollection() {
        ...
        try {
            ...
            const response = await axios.post('https://puffdog-backend.onrender.com/api/createCollection', {
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
                },
    ...
    async function mintToCollection() {
        ...
        try {
            ...
            const response = await axios.post('https://puffdog-backend.onrender.com/api/mintToCollection', {
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
                },
